...
#pydantic Schmeas for structured output
...
# LLMs instances with structured schemas

router_llm=ChatOpenAI(model="gpt-4-turbo",temperature=0).with_structured_output(RouteDecision)
judge_llm=ChatOpenAI(model="gpt-4-turbo",temperature=0).with_structured_output(RagJudge)
answer_llm=ChatOpenAI(model="gpt-4-turbo",temperature=0.7)
